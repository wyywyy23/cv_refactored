...
\boxLevelOne[list=regular]{
    ...
    {Storrs, CT, USA}%
    {\emph{Integrated Photonics Systems in the Package: Beyond Massive Parallel Data Movement}}%
    {Mar. 2026}

    \entryThreeAndTwo%
    {\textbf{Seminar}}%
    {Department of ECE, University of Connecticut}%
    {Storrs, CT, USA}%
    {\emph{Photonics-Empowered Computing: From Efficient to Functional Data Movement}}%
    {Feb. 2025}
